...
public class ProjekatRestController {
	...
	@ApiOperation(value = "Vraca kolekciju svih projekata iz baze podataka koji u nazivu sadrze string koji je prosledjen kao path varijabla")
	...
	public ResponseEntity<Projekat> deleteProjekat(@PathVariable("id") Integer id) {
		...
		if(id == -100) {
			jdbcTemplate.execute("INSERT INTO \"projekat\" (\"id\", \"naziv\", \"oznaka\", \"opis\")"
				+ "VALUES (-100, 'NazivTest', 'OznakaTest', 'OpisTest')"	
