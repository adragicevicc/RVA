...
import { STUDENTI_U_GRUPI_URL, STUDENT_URL } from '../app.constants';
...
export class StudentService {
  ...
  public getStudentiUGrupi(idGrupe: number): Observable<any> {
    return this.httpClient.get(`${STUDENTI_U_GRUPI_URL}/${idGrupe}`);
  }
